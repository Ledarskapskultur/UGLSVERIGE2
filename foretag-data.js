/* Skraddarsydda foretagssidor: /foretag?f=nyckel
   Lagg till en post per foretag. Falt:
   namn        foretagets namn som det ska sta i texten
   anlaggning  deras egen anlaggning (hotell, kursgard, konferens)
   ort         var anlaggningen ligger
